...
Pangolin is an open-source, identity-based remote access platform built on WireGuard® that enables secure, seamless connectivity to edge infrastructure. Take a look at: https://github.com/fosrl/pangolin
